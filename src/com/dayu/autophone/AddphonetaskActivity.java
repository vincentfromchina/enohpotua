...
import com.dayu.autophone.c.ContactPicker;
import com.dayu.autophone.c.DBHelper;
import com.dayu.autophone.c.FolderFilePicker;
import com.dayu.autophone.c.GernatorPHONEtext;
import com.dayu.autophone.c.Getnowtime;
import com.dayu.autophone.c.ContactPicker.PickContactEvent;
import com.dayu.autophone.c.FolderFilePicker.PickPathEvent;
...
public class AddphonetaskActivity extends Activity
{
	...
	private static final String ROOT = Environment
			.getExternalStorageDirectory().toString()+"/autophone/";
	...
	DBHelper sqldb ;
	static PhoneTask m_SmsTask = null;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mInflater = LayoutInflater.from(AddphonetaskActivity.this);
		
		sqldb = new DBHelper(AddphonetaskActivity.this, "dbname", null);
		m_SmsTask = new PhoneTask();
		...
		OnClickListener listener = new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				case R.id.btn_addnewtask:
					...
					{
						Toast.makeText(AddphonetaskActivity.this, "请填写任务名", Toast.LENGTH_LONG).show();
						return;
					}
					...
					{
						Toast.makeText(AddphonetaskActivity.this, "请选择模板", Toast.LENGTH_LONG).show();
						return;
					}
					*/
					...
					if (mfilePath.equals(""))
					{
						Toast.makeText(AddphonetaskActivity.this, "请选文件", Toast.LENGTH_LONG).show();
						return;
					}
					...
					sqldb.insert_phonetask(m_SmsTask);
					
					Intent open_managertaskactivity = new Intent();
					open_managertaskactivity.setClass(AddphonetaskActivity.this, ManagertaskActivity.class);
		...
		lv_chooseplate.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				if (AutoPHONEActivity.isdebug) Log.e(TAG, "plateid:"+plateid.get(position));
				lv_chooseplate.setVisibility(View.GONE);
				tv_contentplatename.setText(platename.get(position));
				
				edt_showcontent.setText(GernatorPHONEtext.getSMSresult(platecontent.get(position)));
			}
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			 final ViewHolder holder;
	            ...
	            if (convertView == null) {
	                    ...
	                    if (AutoPHONEActivity.isdebug)  Log.e(TAG, ""+position+"--"+plateid.get(position));
	                    
	                    convertView.setTag(holder);//绑定ViewHolder对象
	                    
	                    if (AutoPHONEActivity.isdebug) Log.v(TAG, "getView " + position + " " + convertView);
	          }
	          else{
	                    holder = (ViewHolder)convertView.getTag();//取出ViewHolder对象
	                    if (AutoPHONEActivity.isdebug) Log.e(TAG, "会执行");
	                  }
	...
	public void update_dataset()
	{
	    ...
	    m_Cursor =  sqldb.query_contentplate();
		...
		FolderFilePicker picker = new FolderFilePicker(this,
				new PickPathEvent() {
					...
					public void onPickEvent(String resultPath) {
						...
						if (mfilePath==null)
						{
							Toast.makeText(AddphonetaskActivity.this, "请选择文件",
	...
	public void pickContact(View v)
	{
				...
				new PickContactEvent() {
					...
					public void onPickEvent(List<String[]> contact) {
						...
						try
						{
							...
							if (AutoPHONEActivity.isdebug) Log.e(TAG, msavefilepath);
	 ...
	 private void showfiledialog(String filepath)
	 {
		 ...
		 final Builder adAlertDialog = new Builder(AddphonetaskActivity.this);
    ...
    public void readAllContacts() {
        ...
        while(contacts.moveToNext()) {
            ...
            if (AutoPHONEActivity.isdebug) Log.e(TAG, contactId);
            if (AutoPHONEActivity.isdebug) Log.e(TAG, name);
            ...
            while(phones.moveToNext()) {
                ...
                if (AutoPHONEActivity.isdebug) Log.e(TAG, phoneNumber);
            }
