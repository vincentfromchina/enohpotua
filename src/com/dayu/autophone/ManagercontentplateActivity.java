...
public class ManagercontentplateActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		sqldb = new DBHelper(ManagercontentplateActivity.this, "dbname", null);
		...
		lv_contentplate.setOnItemClickListener(new OnItemClickListener()
		{
			...
			{
				//点击后在标题上显示点击了第几行
				if (AutoPHONEActivity.isdebug) Log.e(TAG,"你点击了第"+position +"id:"+id);
               ...
               edt_showresult.setText(GernatorPHONEtext.getSMSresult(platecontent.get(position)));
			}
		...
		lv_contentplate.setOnItemLongClickListener(new OnItemLongClickListener()
		{
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				if (AutoPHONEActivity.isdebug) Log.e(TAG,"你长按了第"+position+"模板名"+platename.get(position));
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			 ViewHolder holder;
                ...
                holder.mod_plate.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View v) {
                    	if (AutoPHONEActivity.isdebug) Log.e(TAG, "你点击了修改按钮" + v.getTag(R.id.mod_key_first_tag));                                //打印Button的点击信息
     				...
     				if (AutoPHONEActivity.isdebug) Log.e(TAG, "start update");
                ...
                holder.delete_plate.setOnClickListener(new OnClickListener()
				{
					...
					public void onClick(View v)
					{
						if (AutoPHONEActivity.isdebug) Log.e(TAG, "你点击了删除按钮" + v.getTag()); 
						...
						{
							sqldb.delrec_phonecontentplate((Integer)v.getTag());
							 update_dataset();
	    ...
	    {  
	        ...
	        {  
	            ...
	            case AlertDialog.BUTTON_POSITIVE:// "确认"按钮退出程序  
	            	...
	            	sqldb.delrec_phonecontentplate(nowclickid);
					 update_dataset();
				     m_datasetadpter.notifyDataSetChanged();
	                break;  
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {  
            ...
            public void onClick(DialogInterface arg0, int arg1) {  
                if (rec_contentplate)
				{
					...
					sqldb.insert_contentplate(edt_contentplate.getText().toString(), contentplate,tmp_time);
	...
	{
		if (AutoPHONEActivity.isdebug) Log.e(TAG, "requestCode"+requestCode+"resultCode"+resultCode);
		if (requestCode==307) //请求编辑短信模板
		{
			if (resultCode==308) //返回短信模板
			{
			    ...
			    if (AutoPHONEActivity.isdebug) Log.e(TAG, contentplate);
			    edt_showresult.setText(GernatorPHONEtext.getSMSresult(contentplate));
			}
			if (resultCode==309)
			{					
				Bundle m_Bundle = data.getExtras();
			    contentplate = m_Bundle.getString("contentplate");
			    if (AutoPHONEActivity.isdebug) Log.e(TAG, "back contentplate"+contentplate);
			    edt_showresult.setText(GernatorPHONEtext.getSMSresult(contentplate));
