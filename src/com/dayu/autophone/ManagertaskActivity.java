...
public class ManagertaskActivity extends Activity
{
	...
	lv_smstask.setOnItemClickListener(new OnItemClickListener()
	{
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id)
		{
           ...
           if (isfirstlongclick)
		   {
        	   ...
        	   Toast.makeText(ManagertaskActivity.this, "长按修改任务名字", Toast.LENGTH_LONG).show();    
		   }   
	...
	lv_smstask.setOnItemLongClickListener(new OnItemLongClickListener()
	{
		...
		public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id)
		{
			...
			if (AutoPHONEActivity.isdebug) Log.e(TAG,"你长按了第"+position+"模板名"+taskname.get(position));
	...
	public void update_dataset()
	{
		...
		while (m_Cursor.moveToNext())
		{
			...
			taskinfo.add("时间:"+m_Cursor.getString(1)+"   外呼数:"+Integer.valueOf(m_Cursor.getInt(7)));
		}
	}
