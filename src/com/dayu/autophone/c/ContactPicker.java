...
import com.dayu.autophone.AddphonetaskActivity;
...
public class ContactPicker extends Dialog {
	...
	private void init(Context context) {
		...
		mContactsLv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				{
					if (AutoPHONEActivity.isdebug) Log.e(TAG, "ViewHolder is null");
				}
			}
		});
	...
	private void setListAdapterData(Context mContext) {
		  ...
		  int contactIdIndex = 0;
	        ...
	        while(contacts.moveToNext()) {
	            ...
	            if (AutoPHONEActivity.isdebug) Log.e(TAG, contact_Id);
	            if (AutoPHONEActivity.isdebug) Log.e(TAG, contact_name);
	...
	private class ContactLvAdapter extends BaseAdapter {
		...
		public long getItemId(int position) {
			if (AutoPHONEActivity.isdebug) Log.e(TAG, "ha from this" + position);
			return position;
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (AutoPHONEActivity.isdebug) Log.e(TAG, "now position: "+position);
