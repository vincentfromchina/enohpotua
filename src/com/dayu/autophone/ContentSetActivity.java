...
public class ContentSetActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AutoPHONEActivity.isdebug) Log.e(TAG, type + " " + plateid);
   ...
   //     view_showcontent.set_screenheight(getApplicationContext().getResources().getDisplayMetrics().heightPixels);
        ...
        edt_content.addTextChangedListener(new TextWatcher()
		{
			...
			//	Log.e("TAG", String.valueOf(s));
				...
				teString = GernatorPHONEtext.getSMSresult(teString);
		    ...
		    HttpEntity mHttpEntity;
		 		    ...
		 		    try
		 			{
		 			   ...
		 			   if (httpresponse.getStatusLine().getStatusCode()==200)	
		 			   {
		 				...
		 				if( AutoPHONEActivity.isdebug )Log.e(TAG, mJsonObject.toString());
						try
						{
							...
							case "4":
								serialid = mJsonObject.getString("serialid");
								if (AutoPHONEActivity.isdebug) Log.e(TAG, serialid);
    ...
    class doreg  extends Thread
{
 	    ...
 	    public void handleMessage(android.os.Message msg) {
 	        ...
 	        switch (msg.what) {
 	            ...
 	            case REG_FAIL:
 	            	...
 	            	break;
 	        default:
 	        	if( AutoPHONEActivity.isdebug ) Log.e(TAG, "Unhandled msg - " + msg.what);
 	        }
 	    }                                       
 	};
    ...
    public String getcontent()
    {
       ...
       if (AutoPHONEActivity.isdebug) Log.e(TAG,"send contentplate"+ tv_edit.getText().toString());
